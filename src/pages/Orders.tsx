...
// //   const subtotal = cart.reduce((sum: number, d: any) => {
// //     const drinkExtras = d.extras
// //       .filter((e: any) => e.ingredient_category_name !== 'Packaging')
// //       .reduce((s: number, e: any) => s + (e.ingredient_cost || 0), 0);
// //     return sum + d.item.item_cost + drinkExtras;
// //   }, 0);
// //   const tax = subtotal * 0.08;
...
//   const removeDrink = (drinkId: number) => setCart(prev => prev.filter(d => d.cart_id !== drinkId));
...
//         );
//       } else {
//         return [...prev, { ...customizingDrink, ingredients: { ...customizingDrink.ingredients } }];
//       }
//     });
...
//                 className="btn"
//                 onClick={() => {
//                   const outOfStock = cart.filter(d => !d.item.in_stock);
//                   if (outOfStock.length > 0) {
//                     const names = outOfStock.map(d => d.item.item_name).join(', ');
//                     alert(`The following item(s) are out of stock: ${names}. Please remove them from your order.`);
//                   } else {
//                     alert("Thank you for your order! Have a nice day.");
//                     setCart([]);
